    ...
    return(
        ...
        <div className='flex relative bg-slate-400 h-24'>
          <div className='bg-green-500 text-white absolute right-28 flex h-full'>
            ...
            <Link to="/staffregister" className='flex justify-center items-center bg-white text-green-500 hover:bg-white hover:text-green-500'><div className='flex align-middle text-xl px-5 cursor-pointer flex-col justify-center hover:bg-white hover:text-green-500 m-0'>Staff Login</div></Link>
        ...
        <div className='w-72 h-64 flex justify-center text-xl rounded-lg border-solid border-2 items-center p-4'>
            <form onSubmit={handleSubmit} className='flex flex-col justify-center w-fit'>
                ...
                <input id="dept" className='px-5 py-3 rounded-b-lg focus:outline-0 focus:border-b-2' type="text" placeholder="Department" name="dept" autoComplete="off" />
