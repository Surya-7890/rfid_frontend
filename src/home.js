...
export default function Home(){
    ...
    return(
        ...
        <div className='bg-slate-200 bg-opacity-30 absolute top-0 flex w-screen justify-center h-10 items-center text-xl'><div className='absolute right-[460px] font-semibold'>MAKERSPACE DASHBOARD</div></div>
        <div className='relative'>
            <div className='h-screen w-1/4 bg-black'>
            <div className='w-1/4'>
